...
fun StatelessFormHubungiKami(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            supportingText = { Text("Pesan minimal 10 karakter") },
            modifier = Modifier
                .fillMaxWidth()
                .height(120.dp),
            shape = MaterialTheme.shapes.medium
        ...
        OutlinedButton(
            ...
            Icon(imageVector = Icons.Default.CheckCircle, contentDescription = "Upload")
        ...
        if (imageUri != null) {
            ...
            Card(colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surfaceVariant)) {
                Row(modifier = Modifier.padding(all = 12.dp), verticalAlignment = Alignment.CenterVertically) {
                    Icon(imageVector = Icons.Default.CheckCircle, contentDescription = "File")
                    Spacer(modifier = Modifier.width(8.dp))
